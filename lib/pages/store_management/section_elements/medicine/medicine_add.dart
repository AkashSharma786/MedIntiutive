...
class MedicineAdd extends StatelessWidget {
  ...
  bool validate() {
    if (serialController.text.isEmpty ||
        ...
        sciNameController.text.isEmpty ||
              ...
              Column(
                ...
                children: [
                  ...
                  ElevatedButton(
                      onPressed: () {
                        if (validate()) {
                          DatabaseService.addItems(
                              DatabaseService.tableName[0], {
                            DatabaseService.medicineFields[1]:
                                nameController.text,
                            DatabaseService.medicineFields[2]:
                                sciNameController.text,
                            DatabaseService.medicineFields[3]:
                                double.parse(mRPController.text),
                            DatabaseService.medicineFields[4]:
                                brandController.text,
                            DatabaseService.medicineFields[5]:
                                typeController.text,
                            DatabaseService.medicineFields[6]:
                                double.parse(sellingPriceController.text),
                            DatabaseService.medicineFields[7]:
                                descriptionController.text,
                            DatabaseService.medicineFields[8]:
                                imageController.text,
                            DatabaseService.medicineFields[9]:
                                usageDirectionController.text,
                            DatabaseService.medicineFields[10]:
              ...
              Column(
                ...
                children: [
                  CustomLabeledTextField(
                      ...
                      hint: "200.00",
                      isPrice: true,
                      widgetControl: sellingPriceController),
                  SizedBox(
                    height: screenSize.height * 0.02,
                  ),
                  CustomLabeledTextField(
                      label: "Description",
                      hint: "two time a day",
                      widgetControl: descriptionController),
                  SizedBox(
                    height: screenSize.height * 0.02,
                  ),
                  CustomLabeledTextField(
                      label: "Image",
                      hint: "D:/image/dolo650.jpg",
                      widgetControl: imageController),
                  SizedBox(
                    height: screenSize.height * 0.02,
                  ),
                  CustomLabeledTextField(
                      label: "usage",
                      hint: "Used in fever ",
                      widgetControl: usageDirectionController),
                  SizedBox(
                    height: screenSize.height * 0.02,
                  ),
                  CustomLabeledTextField(
                      label: "Rack Details",
                      hint: "Placed on rack 14 ",
                      widgetControl: rackDetailsController),
                ],
              ),
            ],
          ),
